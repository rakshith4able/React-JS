...
class App extends React.Component {
    render() {
        return (<Hello from="Rakshiii" to="you"
            src="https://images.unsplash.com/photo-1573224395799-3e4f21436779?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=282&q=80"
            num={3} list={[1, 2, 3, 4, 5]}
        />);
